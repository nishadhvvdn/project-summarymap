...
const fields = [
    `MeterID`, `Meter_DeviceID`, `MeterLatitude`, `MeterLongitude`, `HypersproutID`, `Meter_ReadTimestamp`, `TransformerID`, `Transformer_CellID`, `TransformerLatitude`, `TransformerLongitude`, `Transformer_ReadTimestamp`,  `CircuitID`, `Meter_Line1InstVoltage`, `Meter_Line1InstCurrent`, `Meter_Line1Frequency`, `Meter_Apparent_m_Total`, `Meter_ActiveReceivedCumulativeRate_Total`, `Meter_ActiveDeliveredCumulativeRate_Total`,  `Transformer_Line1Voltage`, `Transformer_Line2Voltage`, `Transformer_Line3Voltage`, `Transformer_Line1Current`, `Transformer_Line2Current`, `Transformer_Line3Current`, `Transformer_AmbientTemperarture`, `Transformer_TopTemperature`, `Transformer_BottomTemperature`, `Transformer_TransformerOilLevel`, `Transformer_Apparent_m_Total`, `Transformer_ActiveReceivedCumulativeRate_Total`, `Transformer_ActiveDeliveredCumulativeRate_Total`, `DateTime`, `Hours`,`Circuit_Latitude`, `Circuit_Longitude`, `Transformer_Latitude`, `Transformer_Longitude`,  `Meter_Latitude`, `Meter_Longitude`, `Transformer_active_energy_received`, `Transformer_active_energy_delivered`, `Meter_active_energy_received`, `Meter_active_energy_delivered`, `Top_Temperature`, `Bottom_Temperature`, `ambient_temparature`, `Energy_Apparent_Absolute`,  `TransformerActiveReceivedCumulativeRate_Total`, `TransformerActiveDeliveredCumulativeRate_Total`, `MeterActiveReceivedCumulativeRate_Total`, `MeterActiveDeliveredCumulativeRate_Total`, `NetworkResponceRate`,  `Apparent_m_Total`,  `Non_technichal_Loss`, `ActualMeter_ReadTimestamp`, `ActualTransformer_ReadTimestamp`, `SolarPanel`, `EVMeter`, `Meter_Line2InstVoltage`, `Meter_Line3InstVoltage`, `Meter_Line2InstCurrent`, `Meter_Line3InstCurrent`, `Meter_Line2Frequency`, `Meter_Line3Frequency`, `Meter_Phase`, `Meter_Line1PowerFactor`, `Meter_Line2PowerFactor`, `Meter_Line3PowerFactor`, `Transformer_Phase`, `Transformer_Line1PhaseAngle`, `Transformer_Line2PhaseAngle`, `Transformer_Line3PhaseAngle`, `Transformer_BatteryVoltage`, `Transformer_BatteryStatus`, `TransformerRating`, `IsHyperHub`, `createdAt`, `updatedAt`,`MeterApparentReceivedCumulativeRate_Total`
];
const latest_fields = [
    ...
    return new Promise((resolve, reject) => {
        dbConMysql.pool.getConnection(function (err, connection) {
            if (summaryArray.length > 0) {
                logger.log('in 1');
                try {
                    csv = json2csv(summaryArray, { fields: fields, quote: '' });
                } catch (err) {
                    reject(err)
                    logger.log(err);
                }
                fs.appendFile(filePath_summary, csv, function (err) {
                    if (err) {
                       ...
                       var sql= "LOAD DATA LOCAL INFILE'" + filePath_summary + "' REPLACE INTO TABLE   summarymap FIELDS TERMINATED BY ',' IGNORE 1 LINES (`MeterID`,     `Meter_DeviceID`,     `MeterLatitude`,     `MeterLongitude`,     `HypersproutID`,     `Meter_ReadTimestamp`,     `TransformerID`,     `Transformer_CellID`,     `TransformerLatitude`, `TransformerLongitude`,     `Transformer_ReadTimestamp`,     `CircuitID`,     `Meter_Line1InstVoltage`,     `Meter_Line1InstCurrent`,     `Meter_Line1Frequency`,     `Meter_Apparent_m_Total`,     `Meter_ActiveReceivedCumulativeRate_Total`,     `Meter_ActiveDeliveredCumulativeRate_Total`,     `Transformer_Line1Voltage`,     `Transformer_Line2Voltage`,     `Transformer_Line3Voltage`,     `Transformer_Line1Current`,     `Transformer_Line2Current`,     `Transformer_Line3Current`,     `Transformer_AmbientTemperarture`,     `Transformer_TopTemperature`,     `Transformer_BottomTemperature`,     `Transformer_TransformerOilLevel`,     `Transformer_Apparent_m_Total`,     `Transformer_ActiveReceivedCumulativeRate_Total`,     `Transformer_ActiveDeliveredCumulativeRate_Total`,     `DateTime`,     `Hours`,     `Circuit_Latitude`,     `Circuit_Longitude`,     `Transformer_Latitude`,     `Transformer_Longitude`,     `Meter_Latitude`,     `Meter_Longitude`,     `Transformer_active_energy_received`,     `Transformer_active_energy_delivered`,     `Meter_active_energy_received`,     `Meter_active_energy_delivered`,     `Top_Temperature`,     `Bottom_Temperature`,     `ambient_temparature`,     `Energy_Apparent_Absolute`,     `TransformerActiveReceivedCumulativeRate_Total`,     `TransformerActiveDeliveredCumulativeRate_Total`,     `MeterActiveReceivedCumulativeRate_Total`,     `MeterActiveDeliveredCumulativeRate_Total`,     `NetworkResponceRate`,     `Apparent_m_Total`,     `Non_technichal_Loss`,     `ActualMeter_ReadTimestamp`,     `ActualTransformer_ReadTimestamp`,     `SolarPanel`,     `EVMeter`,     `Meter_Line2InstVoltage`,     `Meter_Line3InstVoltage`,     `Meter_Line2InstCurrent`,     `Meter_Line3InstCurrent`,     `Meter_Line2Frequency`,     `Meter_Line3Frequency`,     `Meter_Phase`,     `Meter_Line1PowerFactor`,     `Meter_Line2PowerFactor`,     `Meter_Line3PowerFactor`,     `Transformer_Phase`,     `Transformer_Line1PhaseAngle`,     `Transformer_Line2PhaseAngle`,     `Transformer_Line3PhaseAngle`,     `Transformer_BatteryVoltage`,     `Transformer_BatteryStatus`,     `TransformerRating`,     `IsHyperHub`,     `createdAt`,     `updatedAt`, `MeterApparentReceivedCumulativeRate_Total`   ) set id = NULL;"

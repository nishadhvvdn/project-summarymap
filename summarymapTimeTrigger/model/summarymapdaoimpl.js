...
function updateSummaryMapModel(arrDateToCompare, objDeviceMergedData, objHSKey, objDeviceID, objPropertyKey, summaryArray, latestArray, callback) {
    ...
    if (objPropertyKey !== 'managerialdata') {
        ...
        if (objManagerialData.MeterSerialNumber || objManagerialData.Transformer_CellID) {
            ...
            objectToInsert.Meter_Line1InstVoltage = objTransactionData.Meter_Line1InstVoltage ? parseFloat(parseFloat(objTransactionData.Meter_Line1InstVoltage.toFixed(7))) : 0;
            objectToInsert.Meter_Line1InstCurrent = objTransactionData.Meter_Line1InstCurrent ? parseFloat(parseFloat(objTransactionData.Meter_Line1InstCurrent.toFixed(7) )): 0;
            objectToInsert.Meter_Line1Frequency = objTransactionData.Meter_Line1Frequency ? parseFloat(parseFloat(objTransactionData.Meter_Line1Frequency.toFixed(7))) : 0;
            objectToInsert.Meter_Apparent_m_Total = objTransactionData.Meter_Apparent_m_Total ? parseFloat(parseFloat(objTransactionData.Meter_Apparent_m_Total.toFixed(3) )): 0;
            objectToInsert.Meter_ActiveReceivedCumulativeRate_Total = objTransactionData.Meter_ActiveReceivedCumulativeRate_Total ? parseFloat(parseFloat(objTransactionData.Meter_ActiveReceivedCumulativeRate_Total.toFixed(6))) : 0;
            objectToInsert.Meter_ActiveDeliveredCumulativeRate_Total = objTransactionData.Meter_ActiveDeliveredCumulativeRate_Total ? parseFloat(parseFloat(objTransactionData.Meter_ActiveDeliveredCumulativeRate_Total.toFixed(6))) : 0;
